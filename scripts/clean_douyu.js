// ==UserScript==
// @name         clearDouyu
// @namespace    kosette.dy
// @version      1.0
// @description  clear Douyu
// @author       kosette
// @match        *://www.douyu.com/*
// @grant        none
// ==/UserScript==
...
(function () {
    ...
    css += 'div.wm-general:nth-of-type(1){height:25px !important;}';
    css += 'div.wm-general:nth-of-type(3){display:none !important;}';
    css += 'div.wm-general:nth-of-type(4){display:none !important;}';
    css += 'div.wm-general:nth-of-type(5){display:none !important;}';
    css += 'div.wm-general:nth-of-type(6){display:none !important;}';
    css += 'div.wm-general:nth-of-type(7){display:none !important;}';
    css += 'div.wm-general:nth-of-type(8){display:none !important;}';
    css += '.wm-view{display:none !important;}';
    css += '#bc2{display:none !important;}';
    css += '#bc2-bgblur{display:none !important;}';
    css += '#bc3-bgblur{display:none !important;}';
    // css += '#bc4{display:none !important;}';
    // css += '#bc4-bgblur{display:none !important;}';
    // css += '#bc5{display:none !important;}';
    // css += '#bc5-bgblur{display:none !important;}';
    // css += '#bc6{display:none !important;}';
    // css += '#bc6-bgblur{display:none !important;}';
    // css += '#bc7{display:none !important;}';
    // css += '#bc7-bgblur{display:none !important;}';
    // css += '#bc8{display:none !important;}';
    css += '#bc967{display:none !important;}';
